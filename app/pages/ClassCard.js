...
const ClassCard = ({
  ...
  return (
    <div
      className="relative rounded-lg shadow-xl p-4 flex flex-col overflow-hidden bg-white min-w-[300px] max-w-xl mx-auto flex-grow md:max-w-none"
      style={{
      ...
      <div className="flex flex-col flex-grow">
        <div className="flex items-start mb-4">
          ...
          <div className="flex-1 max-w-52">
            ...
            <div className="text-sm text-gray-600 border-b-red-500 border-b-2">
              {source}
            </div>
          </div>
        </div>
